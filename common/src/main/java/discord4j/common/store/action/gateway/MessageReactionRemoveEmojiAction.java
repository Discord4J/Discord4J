...
public class MessageReactionRemoveEmojiAction extends ShardAwareAction<Void> {

    private final MessageReactionRemoveEmoji messageReactionRemoveEmoji;

    MessageReactionRemoveEmojiAction(int shardIndex, MessageReactionRemoveEmoji messageReactionRemoveEmoji) {
        super(shardIndex);
