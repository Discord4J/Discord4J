...
public class ChannelEntity {
	...
	// private/group only
	private Possible<UserEntity[]> recipients = Possible.absent();
	...
	public Possible<OverwriteEntity[]> getPermissionOverwrites() {
		return permissionOverwrites;
	}

	public void setPermissionOverwrites(Possible<OverwriteEntity[]> permissionOverwrites) {
	...
	public Possible<UserEntity[]> getRecipients() {
		return recipients;
	}

	public void setRecipients(Possible<UserEntity[]> recipients) {
