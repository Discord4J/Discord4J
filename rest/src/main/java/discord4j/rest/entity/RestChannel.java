...
public class RestChannel {
     ...
     *
     * @apiNote if the request comes from a {@code Spec} class can be different from a raw {@code ImmutableMessageCreateRequest.Builder#build()} for flags and another internal behaviours
     * @param request request body used to create a new message
