...
public class ChannelService extends RestService {
    ...
    public Mono<Void> addPinnedMessage(long channelId, long messageId) {
        return this.addPinnedMessage(channelId, messageId, null);
    }

    public Mono<Void> addPinnedMessage(long channelId, long messageId, @Nullable String reason) {
    ...
    public Mono<Void> deletePinnedMessage(long channelId, long messageId) {
        return this.deletePinnedMessage(channelId, messageId, null);
    }

    public Mono<Void> deletePinnedMessage(long channelId, long messageId, @Nullable String reason) {
    ...
    public Mono<ChannelData> startThreadWithMessage(long channelId, long messageId,
                                                    StartThreadFromMessageRequest request) {
    ...
    public Mono<ChannelData> startThreadInMediaChannel(long channelId, StartThreadInForumChannelRequest request) {
        return Routes.START_THREAD_IN_FORUM_CHANNEL_MESSAGE.newRequest(channelId)
                .body(request)
                .exchange(getRouter())
                .bodyToMono(ChannelData.class);
