...
public abstract class Routes {
	 ...
	 */
	public static final Route<EmojiResponse[]> GUILD_EMOJIS_GET = Route.get("/guilds/{guild.id}/emojis", EmojiResponse[].class);
	 ...
	 */
	public static final Route<EmojiResponse> GUILD_EMOJI_GET = Route.get("/guilds/{guild.id}/emojis/{emoji.id}", EmojiResponse.class);
	 ...
	 */
	public static final Route<EmojiResponse> GUILD_EMOJI_CREATE = Route.post("/guilds/{guild.id}/emojis", EmojiResponse.class);
	 ...
	 */
	public static final Route<EmojiResponse> GUILD_EMOJI_MODIFY = Route.patch("/guilds/{guild.id}/emojis/{emoji.id}", EmojiResponse.class);
	 ...
	 */
	public static final Route<Void> GUILD_CHANNEL_POSITIONS_MODIFY = Route.patch("/guilds/{guild.id}/channels", Void.class);
	 ...
	 */
	public static final Route<UserResponse[]> GUILD_BANS_GET = Route.get("/guilds/{guild.id}/bans", UserResponse[].class);
