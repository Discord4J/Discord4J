...
public abstract class Routes {
     ...
     */
    public static final Route<Void> REACTION_CREATE = Route.put("/channels/{channel.id}/messages/{message" +
            ".id}/reactions/{emoji}/@me", Void.class);
     ...
     */
    public static final Route<Void> REACTION_DELETE_OWN = Route.delete("/channels/{channel.id}/messages/{message" +
            ".id}/reactions/{emoji}/@me", Void.class);
     ...
     */
    public static final Route<Void> REACTION_DELETE = Route.delete("/channels/{channel.id}/messages/{message" +
            ".id}/reactions/{emoji}/{user.id}", Void.class);
     ...
     */
    public static final Route<UserResponse[]> REACTIONS_GET = Route.get("/channels/{channel.id}/messages/{message" +
            ".id}/reactions/{emoji}", UserResponse[].class);
     ...
     */
    public static final Route<Void> REACTIONS_DELETE_ALL = Route.delete("/channels/{channel.id}/messages/{message" +
            ".id}/reactions", Void.class);
     ...
     */
    public static final Route<MessageResponse> MESSAGE_EDIT = Route.patch("/channels/{channel.id}/messages/{message" +
            ".id}", MessageResponse.class);
     ...
     */
    public static final Route<Void> CHANNEL_PERMISSIONS_EDIT = Route.put("/channels/{channel" +
            ".id}/permissions/{overwrite.id}", Void.class);
     ...
     */
    public static final Route<Void> CHANNEL_PERMISSION_DELETE = Route.delete("/channels/{channel" +
            ".id}/permissions/{overwrite.id}", Void.class);
     ...
     */
    public static final Route<Void> GROUP_DM_RECIPIENT_DELETE = Route.delete("/channels/{channel.id}/recipients/{user" +
            ".id}", Void.class);
     ...
     */
    public static final Route<GuildMemberResponse> GUILD_MEMBER_GET = Route.get("/guilds/{guild.id}/members/{user" +
            ".id}", GuildMemberResponse.class);
     ...
     */
    public static final Route<GuildMemberResponse> GUILD_MEMBER_ADD = Route.put("/guilds/{guild.id}/members/{user" +
            ".id}", GuildMemberResponse.class);
     ...
     */
    public static final Route<Void> GUILD_MEMBER_ROLE_ADD = Route.put("/guilds/{guild.id}/members/{user" +
            ".id}/roles/{role.id}", Void.class);
     ...
     */
    public static final Route<Void> GUILD_MEMBER_ROLE_REMOVE = Route.delete("/guilds/{guild.id}/members/{user" +
            ".id}/roles/{role.id}", Void.class);
     ...
     */
    public static final Route<VoiceRegionResponse[]> GUILD_VOICE_REGIONS_GET = Route.get("/guilds/{guild" +
            ".id}/regions", VoiceRegionResponse[].class);
     ...
     */
    public static final Route<IntegrationResponse[]> GUILD_INTEGRATIONS_GET = Route.get("/guilds/{guild" +
            ".id}/integrations", IntegrationResponse[].class);
     ...
     */
    public static final Route<Void> GUILD_INTEGRATION_MODIFY = Route.patch("/guilds/{guild" +
            ".id}/integrations/{integration.id}", Void.class);
     ...
     */
    public static final Route<Void> GUILD_INTEGRATION_DELETE = Route.delete("/guilds/{guild" +
            ".id}/integrations/{integration.id}", Void.class);
     ...
     */
    public static final Route<Void> GUILD_INTEGRATION_SYNC = Route.post("/guilds/{guild.id}/integrations/{integration" +
            ".id}/sync", Void.class);
     ...
     */
    public static final Route<WebhookResponse> WEBHOOK_TOKEN_GET = Route.get("/webhooks/{webhook.id}/{webhook" +
            ".token}", WebhookResponse.class);
     ...
     */
    public static final Route<WebhookResponse> WEBHOOK_TOKEN_MODIFY = Route.patch("/webhooks/{webhook.id}/{webhook" +
            ".token}", WebhookResponse.class); // TODO: return type wrong
     ...
     */
    public static final Route<Void> WEBHOOK_EXECUTE_SLACK = Route.post("/webhooks/{webhook.id}/{webhook" +
            ".token}/slack", Void.class);
