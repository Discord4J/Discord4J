...
public interface Router {
	...
	/**
	 * Execute a given {@link discord4j.route.CompleteRoute}.
	 *
	...
	/**
	 * Execute a given {@link discord4j.route.CompleteRoute} with a request entity as body.
	 *
	 * @param route the route to use
	...
	/**
	 * Execute a given {@link discord4j.route.CompleteRoute} with a request entity as body and an exchange filter.
	 *
	 * @param route the route to use
	 * @param requestEntity the request entity for request body
