 ...
 * @see IChannel#getMessageHistoryBefore(java.time.LocalDateTime)
 * @see IChannel#getMessageHistoryBefore(java.time.LocalDateTime, int)
 * @see IChannel#getMessageHistoryBefore(long)
 * @see IChannel#getMessageHistoryBefore(long, int)
 * @see IChannel#getMessageHistoryBetween(java.time.LocalDateTime, java.time.LocalDateTime)
 * @see IChannel#getMessageHistoryBetween(java.time.LocalDateTime, java.time.LocalDateTime, int)
 * @see IChannel#getMessageHistoryBetween(long, long)
 * @see IChannel#getMessageHistoryBetween(long, long, int)
 * @see IChannel#getMessageHistoryAfter(java.time.LocalDateTime)
 * @see IChannel#getMessageHistoryAfter(java.time.LocalDateTime, int)
 * @see IChannel#getMessageHistoryAfter(long)
 * @see IChannel#getMessageHistoryAfter(long, int)
 */
