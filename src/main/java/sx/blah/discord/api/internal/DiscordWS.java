...
public class DiscordWS extends WebSocketClient {
	...
	public void onOpen(ServerHandshake serverHandshake) {
		if (!client.token.isEmpty()) {
			send(DiscordClientImpl.GSON.toJson(new ConnectRequest(client.token, "Java", "Discord4J", "Discord4J", "", "")));
	...
	public final void onMessage(String frame) {
		...
		switch (type) {
			case "READY":
				...
				ReadyEventResponse event = DiscordClientImpl.GSON.fromJson(eventObject, ReadyEventResponse.class);
				...
				for (GuildResponse guildResponse : event.guilds) {
					Guild guild;
					client.guildList.add(guild = new Guild(guildResponse.name, guildResponse.name, guildResponse.icon, guildResponse.owner_id));
			...
			case "MESSAGE_CREATE":
				MessageResponse event1 = DiscordClientImpl.GSON.fromJson(eventObject, MessageResponse.class);
			...
			case "TYPING_START":
				TypingEventResponse event2 = DiscordClientImpl.GSON.fromJson(eventObject, TypingEventResponse.class);
			...
			case "GUILD_CREATE":
				GuildResponse event3 = DiscordClientImpl.GSON.fromJson(eventObject, GuildResponse.class);
			...
			case "GUILD_MEMBER_ADD":
				GuildMemberAddEventResponse event4 = DiscordClientImpl.GSON.fromJson(eventObject, GuildMemberAddEventResponse.class);
			...
			case "GUILD_MEMBER_REMOVE":
				GuildMemberRemoveEventResponse event5 = DiscordClientImpl.GSON.fromJson(eventObject, GuildMemberRemoveEventResponse.class);
			...
			case "MESSAGE_UPDATE":
				MessageResponse event6 = DiscordClientImpl.GSON.fromJson(eventObject, MessageResponse.class);
				String id = event6.id;
			...
			case "MESSAGE_DELETE":
				MessageDeleteEventResponse event7 = DiscordClientImpl.GSON.fromJson(eventObject, MessageDeleteEventResponse.class);
				id = event7.id;
			...
			case "PRESENCE_UPDATE":
				PresenceUpdateEventResponse event8 = DiscordClientImpl.GSON.fromJson(eventObject, PresenceUpdateEventResponse.class);
			...
			case "GUILD_DELETE":
				GuildResponse event9 = DiscordClientImpl.GSON.fromJson(eventObject, GuildResponse.class);
			...
			case "CHANNEL_CREATE":
				...
				if(isPrivate) { // PM channel.
					PrivateChannelResponse event10 = DiscordClientImpl.GSON.fromJson(eventObject, PrivateChannelResponse.class);
					id = event10.id;
					boolean b = false;
					...
					ChannelCreateEventResponse event10 = DiscordClientImpl.GSON.fromJson(eventObject, ChannelCreateEventResponse.class);
					id = event10.id;
					type = event10.type;
			...
			case "CHANNEL_DELETE":
				ChannelCreateEventResponse event11 = DiscordClientImpl.GSON.fromJson(eventObject, ChannelCreateEventResponse.class);
			...
			case "USER_UPDATE":
				UserUpdateEventResponse event12 = DiscordClientImpl.GSON.fromJson(eventObject, UserUpdateEventResponse.class);
