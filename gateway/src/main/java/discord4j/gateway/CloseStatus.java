...
/**
 * Representation of WebSocket "close" status codes and reasons. Status codes in the 1xxx range are pre-defined by the
 * protocol.
 *
...
public final class CloseStatus {
	 ...
	 * its policy. This is a generic status code that can be returned when there is no other more suitable status code
	...
	public boolean equals(Object other) {
		...
		return (this.code == otherStatus.code && nullSafeEquals(this.reason, otherStatus.reason));
	}
	...
	@Override
	public int hashCode() {
		return this.code * 29 + (this.reason == null ? 0 : this.reason.hashCode());
	}
