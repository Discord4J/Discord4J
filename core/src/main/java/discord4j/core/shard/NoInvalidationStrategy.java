...
/**
 * A no-op {@link InvalidationStrategy}, meaning that no action will occur on stores on shard session closure.
 */
class NoInvalidationStrategy implements InvalidationStrategy {
