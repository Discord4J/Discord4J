...
public final class ImageUtil {
    ...
    /**
     * Gets the URL using a path and the {@link discord4j.rest.util.Image.Format} the URL should represent.
     *
     * @param path The path of the image; excluding the extension.
     * @param format The {@link discord4j.rest.util.Image.Format} the URL should represent.
     * @return The URL using the path and the {@link discord4j.rest.util.Image.Format} the URL represents
     */
