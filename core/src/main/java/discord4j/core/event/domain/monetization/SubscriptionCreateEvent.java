 ...
 *
 * @see <a href="https://discord.com/developers/docs/topics/gateway-events#subscription-create">New Subscription</a>
 */
...
public class SubscriptionCreateEvent extends Event {
    ...
    public SubscriptionCreateEvent(GatewayDiscordClient gateway, ShardInfo shardInfo, Subscription subscription) {
