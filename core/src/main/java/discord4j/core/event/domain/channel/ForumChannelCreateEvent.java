...
/**
 * Dispatched when a {@link ForumChannel} is created in a guild.
 * <p>
...
public class ForumChannelCreateEvent extends ChannelEvent {
    ...
    public ForumChannelCreateEvent(GatewayDiscordClient gateway, ShardInfo shardInfo, ForumChannel channel) {
        super(gateway, shardInfo);
        this.channel = channel;
    }

    /**
     * Gets the {@link ForumChannel} that was created in this event.
     *
     * @return The newly created {@link ForumChannel}.
     */
