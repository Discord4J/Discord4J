...
public class StoreChannelCreateEvent extends ChannelEvent {
    ...
    public StoreChannelCreateEvent(GatewayAggregate gateway, ShardInfo shardInfo, StoreChannel channel) {
        super(gateway, shardInfo);
        this.channel = channel;
    }

    /**
     * Gets the {@link StoreChannel} that was created in this event.
     *
     * @return The newly created {@link StoreChannel}.
     */
    ...
    public String toString() {
        return "StoreChannelCreateEvent{" +
                "channel=" + channel +
                '}';
    }
}
