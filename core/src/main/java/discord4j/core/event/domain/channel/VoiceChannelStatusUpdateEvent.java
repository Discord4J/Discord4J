...
/**
 * Dispatched when a {@link VoiceChannel} status changes.
 * <p>
 * This event is dispatched by Discord.
 *
 * @see <a href="https://docs.discord.com/developers/events/gateway-events#voice-channel-status-update">
 * Voice Channel Status Update</a>
 */
public class VoiceChannelStatusUpdateEvent extends ChannelEvent {

    private final long guildId;
    private final long channelId;
    private final @Nullable String status;

    public VoiceChannelStatusUpdateEvent(
    ...
    /**
     * Gets the {@link Snowflake} ID of the guild that had a voice channel status update in this event.
     *
    ...
    /**
     * Requests to retrieve the {@link Guild} that had a voice channel status update in this event.
     *
    ...
    /**
     * Gets the {@link Snowflake} ID of the channel that had a voice channel status update in this event.
     *
