...
public class StoreChannelDeleteEvent extends ChannelEvent {
    ...
    public StoreChannelDeleteEvent(GatewayAggregate gateway, ShardInfo shardInfo, StoreChannel channel) {
        super(gateway, shardInfo);
        this.channel = channel;
    }

    /**
     * Gets the {@link StoreChannel} that was deleted in this event.
     *
     * @return The deleted {@link StoreChannel}.
     */
    ...
    public String toString() {
        return "StoreChannelDeleteEvent{" +
                "channel=" + channel +
                '}';
    }
}
