...
@Value.Immutable
public interface SoundboardSoundEditSpecGenerator extends AuditSpec<SoundboardSoundModifyRequest> {
    ...
    @Override
    default SoundboardSoundModifyRequest asRequest() {
        ImmutableSoundboardSoundModifyRequest.Builder builder = SoundboardSoundModifyRequest.builder();
...
abstract class SoundboardSoundEditMonoGenerator extends Mono<SoundboardSound> implements SoundboardSoundEditSpecGenerator {

    abstract SoundboardSound soundboardSound();

    @Override
    public void subscribe(CoreSubscriber<? super SoundboardSound> actual) {
        soundboardSound().edit(SoundboardSoundEditSpec.copyOf(this)).subscribe(actual);
    }
