...
public class LegacyGuildCreateSpec implements LegacySpec<GuildCreateRequest> {
     ...
     * @return This spec.
     */
    public LegacyGuildCreateSpec setRegion(Region region) {
     ...
     * @return This spec.
     */
    public LegacyGuildCreateSpec setVerificationLevel(Guild.VerificationLevel verificationLevel) {
     ...
     * @return This spec.
     */
    public LegacyGuildCreateSpec setDefaultMessageNotificationLevel(Guild.NotificationLevel notificationLevel) {
     ...
     * @return This spec.
     */
    public LegacyGuildCreateSpec setExplicitContentFilter(Guild.ContentFilterLevel explicitContentFilter) {
