 ...
 */
public class LegacyAudioChannelEditSpec implements LegacyAuditSpec<ChannelModifyRequest> {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setName(String name) {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setPosition(int position) {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setPermissionOverwrites(Set<? extends PermissionOverwrite> permissionOverwrites) {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setParentId(@Nullable Snowflake parentId) {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setBitrate(int bitrate) {
     ...
     * @return This spec.
     */
    public LegacyAudioChannelEditSpec setRtcRegion(@Nullable String rtcRegion) {
        requestBuilder.rtcRegionOrNull(rtcRegion);
        return this;
    }

    @Override
    public LegacyAudioChannelEditSpec setReason(@Nullable final String reason) {
        this.reason = reason;
        return this;
    }
