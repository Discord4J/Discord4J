...
public class WebhookEditWithTokenSpec implements Spec<WebhookModifyWithTokenRequest> {
     ...
     * @return This spec.
     */
    public WebhookEditWithTokenSpec setName(String name) {
     ...
     * @return This spec.
     */
    public WebhookEditWithTokenSpec setAvatar(@Nullable Image avatar) {
