...
public class GatewayAggregate {
    ...
    protected GatewayAggregate(Builder builder) {
    ...
    public static GatewayAggregate.Builder builder() {
        return new Builder();
    }
    ...
    public static class Builder {
        ...
        public GatewayAggregate build() {
            return new GatewayAggregate(this);
        }
    }
    ...
    private static final Logger log = Loggers.getLogger(GatewayAggregate.class);
    ...
    public void logoutNow() {
        logout().block(Duration.ofSeconds(30));
    }
}
