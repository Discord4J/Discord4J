 ...
 */
public class Separator extends Component<SeparatorComponentData> implements TopLevelComponent,
    ...
    public static Separator of() {
        return new Separator(SeparatorComponentData.builder().build());
    }
    ...
    public static Separator of(boolean visible) {
        return new Separator(SeparatorComponentData.builder()
                .divider(visible)
                .build());
    }
    ...
    protected Separator(Integer id, boolean visible, SpacingSize spacingSize) {
        this(SeparatorComponentData.builder()
    ...
    public static Separator of(SeparatorComponentData data) {
        return new Separator(data);
    }

    private Separator(SeparatorComponentData data) {
        super(data);
    }
