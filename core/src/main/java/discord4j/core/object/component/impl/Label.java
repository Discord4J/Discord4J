...
public class Label extends Component<LabelComponentData> implements TopLevelModalComponent {
    ...
    public static Label of(LabelComponentData data) {
    ...
    private Label(LabelComponentData data) {
        super(data);
    }
    ...
    public Component<?> getComponent() {
        return Component.fromData(this.getData().component());
    }
