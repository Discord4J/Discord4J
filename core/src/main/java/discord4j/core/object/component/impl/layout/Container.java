 ...
 */
public class Container extends LayoutComponent<ContainerComponentData> implements TopLevelComponent {
     ...
     * @return A {@link Container} containing the given components.
     */
    public static Container of(int id, @Nullable Color color,
                               List<? extends ICanBeUsedInContainerComponent> components) {
    ...
    public static Container of(ContainerComponentData data) {
    ...
    protected Container(ContainerComponentData data) {
        super(data);
    }
