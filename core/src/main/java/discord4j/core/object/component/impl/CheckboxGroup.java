...
public class CheckboxGroup extends Component<CheckboxGroupComponentData> implements ICanBeUsedInLabelComponent {
    ...
    public static CheckboxGroup of(CheckboxGroupComponentData data) {
        return new CheckboxGroup(data);
    }

    private CheckboxGroup(CheckboxGroupComponentData data) {
        super(data);
    }
