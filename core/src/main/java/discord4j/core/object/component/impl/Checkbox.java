...
public class Checkbox extends Component<CheckboxComponentData> implements ICanBeUsedInLabelComponent {
    ...
    public static Checkbox of(CheckboxComponentData data) {
        return new Checkbox(data);
    }

    private Checkbox(CheckboxComponentData data) {
        super(data);
    }
