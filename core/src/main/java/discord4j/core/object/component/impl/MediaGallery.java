...
import discord4j.core.object.component.impl.item.MediaGalleryItem;
 ...
 */
public class MediaGallery extends Component<MediaGalleryComponentData> implements TopLevelComponent,
    ...
    public static MediaGallery of(MediaGalleryComponentData data) {
        return new MediaGallery(data);
    }

    private MediaGallery(MediaGalleryComponentData data) {
        super(data);
    }
