...
public class RadioGroup extends Component<RadioGroupComponentData> implements ICanBeUsedInLabelComponent {
    ...
    public static RadioGroup of(RadioGroupComponentData data) {
        return new RadioGroup(data);
    }

    private RadioGroup(RadioGroupComponentData data) {
        super(data);
    }
