...
public interface ICanHavePlaceholderComponent<D extends ComponentData, T extends Component<D>> {

    ICanHavePlaceholder getData();

    default Optional<String> getPlaceholder() {
        return getData().placeholder().toOptional();
    }

    T withPlaceholder(String placeholder);
