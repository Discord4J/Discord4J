 ...
 */
package discord4j.core.object.component.impl.item;
...
public class MediaGalleryItem {
    ...
    public static MediaGalleryItem of(MediaGalleryItemData data) {
        return new MediaGalleryItem(data);
    }

    private MediaGalleryItem(MediaGalleryItemData data) {
        this.data = data;
    }
