 ...
 */
public class FileUpload extends Component<FileUploadComponentData> implements ICanBeUsedInLabelComponent {
    ...
    public static FileUpload of(FileUploadComponentData data) {
        return new FileUpload(data);
    }

    private FileUpload(FileUploadComponentData data) {
        super(data);
    }
