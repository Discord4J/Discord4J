...
public final class EmbedThumbnail implements DiscordObject {
    ...
    /**
     * Constructs an {@code EmbedThumbnail} with an associated ServiceMediator and Discord data.
     *
     * @param serviceMediator The ServiceMediator associated to this object, must be non-null.
     * @param data The raw data as represented by Discord, must be non-null.
     */
    EmbedThumbnail(final ServiceMediator serviceMediator, final EmbedThumbnailBean data) {
