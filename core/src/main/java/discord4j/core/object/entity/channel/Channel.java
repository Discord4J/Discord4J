...
public interface Channel extends Entity {
    ...
    /**
     * Gets whether this channel is obfuscated.
     *
     * @return Whether this channel is obfuscated for this client.
     */
    ...
    enum Flag {
         ...
         *
         * @return N in {@literal 1 << N} that is the bit value for this flag
         */
