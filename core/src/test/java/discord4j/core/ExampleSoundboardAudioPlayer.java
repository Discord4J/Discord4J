...
public class ExampleSoundboardAudioPlayer {

    private static final Logger log = Loggers.getLogger(ExampleSoundboardAudioPlayer.class);
    ...
    public static void main(String[] args) {
        DiscordClient.create(token)
                .withGateway(ExampleSoundboardAudioPlayer::setup)
                .block();
    }
