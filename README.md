...
[![Javadocs](https://javadoc.io/badge2/com.discord4j/discord4j-core/3.2.4/javadoc.svg?color=blue&style=flat-square)](https://javadoc.io/doc/com.discord4j/discord4j-core/3.2.4)
...
libraryDependencies ++= Seq(
  "com.discord4j" % "discord4j-core" % "3.2.4"
)
```
